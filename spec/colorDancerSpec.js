describe('colorDancer', function() {
  ...
  describe('color', function() {
    it('should have called the randomColor method', function() {
      sinon.spy(colorDancer, 'randomColor');
      colorDancer.randomColor();
      expect(colorDancer.randomColor.called).to.be.true;
    });
  });
